...
class EntityManager:
    ...
    def update_entities(self, messages:list, prior_summaries:list=[]):
        """
...
class SimpleEntityManager(EntityManager):
    ...
    def __init__(self, llm:LLM):
        ...
        Args:
        llm (LLM): the LLM to use for generating the entity list
        """
        self.llm:LLM = llm
        self.entity_list:str = None

        # and the default prompt to generate it
        self.prompt_entity_list = "You are creating a list of all important entities mentioned thus far \
